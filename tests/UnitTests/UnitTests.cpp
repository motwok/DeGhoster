...
//
// Native unit tests for DeGhoster host/DLL code that the end-to-end tests reach
// poorly:
//   * Settings persistence   - drives the real Settings.cpp against an ISOLATED
//     registry root (DEGHOSTER_SETTINGS_ROOT), so HKCU\Software\DeGhoster is
//     never touched.
//   * Hook DLL cloak/uncloak - loads DeGhoster.Hook64.dll, installs the hook on
//     THIS thread, and drives DGH_CLOAK / DGH_UNCLOAK against a self-made ghost
//     window (no cross-process injection needed), covering the cloak, uncloak,
//     remove and detach paths.
//
...
#include "Settings.h"
#include "Theme.h"
#include "Hook.h"   // DGH_CLOAK / DGH_UNCLOAK / DWMWA_CLOAK / DWMWA_CLOAKED
