...
#
# Native C++ code coverage for DeGhoster via OpenCppCoverage.
#
# Builds the binaries (Debug, x86 + x64, with PDBs), runs the integration tests
# under OpenCppCoverage covering the launched native processes (DeGhoster, the
# hooks, Helper32, GhostSim), and writes a Cobertura XML + HTML report to
# coverage\.
#
#   .\tests\coverage.ps1
#
