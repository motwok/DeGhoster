...
#
# Builds the portable ZIP deployment of DeGhoster from the current build/
# output. Produces  dist/DeGhoster-<FullSemVer>-win-x64.zip
#
# Assumes the binaries are already built (run build.ps1, or the two cmake
# workflow presets, first).
